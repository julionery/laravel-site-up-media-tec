<aside id="sidebar" class="sidebar c-overflow">
    ...
    <ul class="main-menu">
        ...
        <li @if(Request::segment(2) == 'categorias') class="active" @endif>
            <a href="{{ route('admin.categorias') }}"><i class="zmdi zmdi-tag-more zmdi-hc-fw"></i> Categorias</a>
        </li>

        <li @if(Request::segment(2) == 'produtos') class="active" @endif>
            <a href="{{ route('admin.produtos') }}"><i class="zmdi zmdi-local-dining zmdi-hc-fw"></i> Produtos</a>
        </li>
        ...
        <li @if(Request::segment(2) == 'equipe') class="active" @endif>
            <a href="{{ route('admin.equipe') }}"><i class="zmdi zmdi-accounts-add"></i> Notícias</a>
        </li>
