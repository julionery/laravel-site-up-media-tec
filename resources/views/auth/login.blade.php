...
<div class="login-content">
    <div class="lc-block toggled" id="l-login">
        ...
        <div class="lcb-navigation">
            <a href="{{ url('auth/github/') }}" data-ma-block="#l-github"><i class="zmdi zmdi-github"></i> <span>GitHub</span></a>
            <a href="{{ url('auth/facebook/') }}" data-ma-block="#l-facebook"><i class="zmdi zmdi-facebook"></i> <span>Facebook</span></a>
            <a href="{{ url('auth/twitter/') }}" data-ma-block="#l-twitter"><i class="zmdi zmdi-twitter"></i> <span>Twitter</span></a>
            <a href="{{ url('auth/google/') }}" data-ma-block="#l-google"><i class="zmdi zmdi-google-plus"></i> <span>Google+</span></a>
        </div>
