...
Route::group(['prefix' => 'admin', 'middleware' => 'auth', 'as' => 'admin.'], function () {
    ...
    Route::get('/produtos/adicionar', ['as' => 'produtos.adicionar', 'uses' => 'Admin\ProdutoController@adicionar']);
    Route::post('/produtos/salvar', ['as' => 'produtos.salvar', 'uses' => 'Admin\ProdutoController@salvar']);
    Route::get('/produtos/editar/{id}', ['as' => 'produtos.editar', 'uses' => 'Admin\ProdutoController@editar']);
    Route::put('/produtos/atualizar/{id}', ['as' => 'produtos.atualizar', 'uses' => 'Admin\ProdutoController@atualizar']);
    Route::get('/produtos/deletar/{id}', ['as' => 'produtos.deletar', 'uses' => 'Admin\ProdutoController@deletar']);

    Route::get('/categorias', ['as' => 'categorias', 'uses' => 'Admin\CategoriaController@index']);
    Route::get('/categorias/adicionar', ['as' => 'categorias.adicionar', 'uses' => 'Admin\CategoriaController@adicionar']);
    Route::post('/categorias/salvar', ['as' => 'categorias.salvar', 'uses' => 'Admin\CategoriaController@salvar']);
    Route::get('/categorias/editar/{id}', ['as' => 'categorias.editar', 'uses' => 'Admin\CategoriaController@editar']);
    Route::put('/categorias/atualizar/{id}', ['as' => 'categorias.atualizar', 'uses' => 'Admin\CategoriaController@atualizar']);
    Route::get('/categorias/deletar/{id}', ['as' => 'categorias.deletar', 'uses' => 'Admin\CategoriaController@deletar']);
