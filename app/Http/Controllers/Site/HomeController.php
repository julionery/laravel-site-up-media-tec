...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $sobre2 = Pagina::where('tipo', '=', 'sobre2')->first();
        $noticia = Pagina::where('tipo', '=', 'noticias')->first();
        $contato = Pagina::where('tipo', '=', 'contato')->first();

        $trabalhos = Portfolio::where('publicar', '=', 'sim')->orderBy('id', 'desc')->take(12)->get();
        ...
        $noticiasInfo = Equipe::where('publicar', '=', 'sim')->orderBy('id', 'desc')->take(3)->get();
        ...
        return view('welcome', compact('header', 'portfolio', 'servicos', 'sobre', 'sobre2', 'noticia', 'contato', 'trabalhos', 'servicosInfo', 'sobreInfo', 'noticiasInfo', 'configuracao'));
    }
